...
Route::get('couseable/{morphable}/passages/index/{passage?}', [CCD\CourseSession\PassageController::class, 'index'])->name('passages.index');
Route::post('courseable/{morphable}/passages/store', [CCD\CourseSession\PassageController::class, 'store'])->name('passages.store');
...
Route::get('courseable/{morphable}/instructions/index/{instruction?}', [CCD\CourseSession\InstructionController::class, 'index'])->name('instructions.index');
Route::post('courseable/{morphable}/instructions/store', [CCD\CourseSession\InstructionController::class, 'store'])->name('instructions.store');
...
// Question
Route::get('questions/courseable/{morphable}/index', [CCD\QuestionController::class, 'index'])->name('questions.index');
Route::get('questions/courseable/{morphable}/create', [CCD\QuestionController::class, 'create'])->name('questions.create');
Route::post('questions/courseable/{morphable}/store', [CCD\QuestionController::class, 'store'])->name('questions.store');
...
Route::post(
    'questions/{morphable}/image-upload', CCD\UploadTinyMceImageController::class
)->name('api.questions.image-upload');

Route::post('api/questions/{morphable}/store', [CCD\QuestionController::class, 'storeApi'])->name('api.questions.store');
