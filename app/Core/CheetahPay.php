...
class CheetahPay
{
    private static $privateKey = CHEETAHPAY_PRIVATE_KEY;
    private static $publicKey = CHEETAHPAY_PUBLIC_KEY;
    private static $endpoint = DEV?'http://localhost/cheetahpay/api/v1':'https://cheetahpay.com.ng/api/v1';
...
//     }
    ...
    function multiPinDeposit(array $data)
    {
        $curl_post_data = array
        (
            'mode' => 'multi-pin',
