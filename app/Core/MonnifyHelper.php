...
class MonnifyHelper
{
  ...
  public function initiateSingleTransfer(array $data): Res
  {
    return $this->execCurl(
      $this->url('v2/disbursements/single'),
      $data,
      'POST',
      true
    );
  ...
  public function initiateBulkTransfer(array $data): Res
  {
    return $this->execCurl(
      $this->url('v2/disbursements/batch'),
      $data,
      'POST',
      true
    );
  ...
  public function getSingleTransferStatus(string $reference): Res
  {
    $url = $this->url(
      'v2/disbursements/single/summary?reference=' . urlencode($reference)
    );

    return $this->execCurl($url, [], 'GET', true);
  }

  public function getBulkTransferStatus(string $batchReference): Res
  {
    $url = $this->url(
      'v2/disbursements/bulk/summary?batchReference=' .
        urlencode($batchReference)
    );
