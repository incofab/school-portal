...
class RecruitmentApplication extends Model
{
    ...
    public static function createRule(): array
    {
        return [
            ...
            'cover_letter' => ['nullable', 'required_without:cover_letter_url', 'string'],
            'cover_letter_url' => ['nullable', 'required_without:cover_letter', 'url', 'max:2048'],
    ...
    protected function name(): Attribute
    {
        return Attribute::make(
            get: fn () => trim("{$this->first_name} {$this->other_names} {$this->last_name}")
        );
    }
