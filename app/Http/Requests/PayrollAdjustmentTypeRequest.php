...
class PayrollAdjustmentTypeRequest extends FormRequest
{
  /**
  ...
  public function rules(): array
  {
    return [
      'title' => [
        ...
        'max:255',
        'min:3',
        (new ValidateUniqueRule(PayrollAdjustmentType::class, 'title'))->when(
          $this->adjustmentType,
          fn($rule) => $rule->ignore($this->adjustmentType->id)
        )
      ],
      'type' => ['required', new Enum(TransactionType::class)],
      'parent_id' => ['nullable', 'exists:adjustment_types,id'],
  ...
  public function attributes(): array
  {
    return [
      ...
      'parent_id' => 'parent adjustment type',
