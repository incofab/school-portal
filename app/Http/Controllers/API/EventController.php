...
class EventController extends Controller
{
	...
	function __construct(
	    \App\Helpers\EventHelper $eventHelper
    ){
	...
	function index(Request $request)
	{
	    ...
	    $ret = $this->eventHelper->list(null, $institution->id, $this->numPerPage, $this->page);
	    
	    return $this->emitResponseRet($ret);
	}
	
	function downloadEventContent(\App\Helpers\EventContentHelper $eventContentHelper, Request $request)
	{
