...
class LibraryController extends Controller
{
  public function __construct()
  {
    ...
    $this->allowedPermissions([InstitutionPermission::ManageLibrary])->except([
      'index',
      'show'
    ]);
  }
  ...
  public function index(Request $request, Institution $institution)
  {
    ...
    return Inertia::render('institutions/libraries/list-libraries', [
      'libraries' => paginateFromRequest($query->latest('libraries.id'))
    ]);
  }
  ...
  public function store(Institution $institution, LibraryRequest $request)
  {
    (new RecordLibrary(
      $institution,
