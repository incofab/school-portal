...
import { Classification, InstitutionUser, Student, User } from '@/types/models';
...
export default function Profile({ student }: Props) {
  ...
  const filename = `admission-letter-${
    student?.user!.full_name ?? generateUniqueString('admission-letter')
  }.pdf`;

  return (
    <PagePrintLayout filename={filename} contentId={'admission-letter'}>
        ...
        <Div mx={'auto'} width={'720px'} px={3}>
          <VStack align={'stretch'}>
            ...
            >
              ...
              <Text>
                I am pleased to inform you that following your good performance,
                you have been offered provisional admission into{' '}
                {student?.classification!.title} in {currentInstitution.name} .
              </Text>
              <Text>
                If you accept the offer, you are required to pay acceptance fee
                as well as other charges and present the following during
                registration:
                <OrderedList>
                  <ListItem>
              ...
              <Text>
                Please accept my congratulations on behalf of the UPWA Group of
                Schools on your admission.
              </Text>
              <Text>
                Yours Faithfully,
                <br />
