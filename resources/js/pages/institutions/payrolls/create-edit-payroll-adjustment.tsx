...
// import AdjustmentTypeSelect from '@/components/selectors/payroll-adjustment-type-select';
...
// export default function CreateEditPayrollAdjustment({
//   payrollAdjustment,
...
//     month: payrollAdjustment?.month ?? '',
//     year: payrollAdjustment?.year ?? '',

//     institution_user_id: payrollAdjustment?.institution_user
//       ? {
...
//       return;
//     }
//     Inertia.visit(instRoute('payroll-adjustments.index'));
//   };

//   const selectedAdjustmentType = webForm.data.payroll_adjustment_type_id
//     ? payrollAdjustmentTypes.find(
//         (item) => item.id === webForm.data.payroll_adjustment_type_id
//       )
//     : null;
//   return (
//     <DashboardLayout>
...
//           <SlabHeading
//             title={`${
//               payrollAdjustment ? 'Update' : 'Create'
//             } Salary Adjustment`}
//           />
//           <SlabBody>
//             <VStack
...
//                   isMulti={false}
//                   required
//                   isDisabled={payrollAdjustment ? true : false}
//                 />
//               </FormControlBox>
