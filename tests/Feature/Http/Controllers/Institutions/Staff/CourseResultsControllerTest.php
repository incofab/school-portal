...
it('loads the selected students existing course result on the recording page', function () {
...
it('keeps the selected student on the recording page when no result exists yet', function () {
    $student = Student::factory()
        ->withInstitution($this->institution, $this->classification)
        ->create();
...
it(
    ...
    function () {
        ...
        actingAs($this->instAdmin)
            ...
            ->assertStatus(423)
            ->assertJsonFragment([
                'message' => 'This class result is locked. Unlock it from Class Result Analysis before adding or editing results.',
            ]);
